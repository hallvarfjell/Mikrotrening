...
(function(){
  ...
  // Zones (under LT1, LT1-LT2, over LT2)
  ...
  function drawGraph(){
    ...
    const smin=Math.min(...spVals, 0), smax=Math.max(...spVals, 1);
    const wmin=Math.min(...wtVals, 0), wmax=Math.max(...wtVals, 1);
